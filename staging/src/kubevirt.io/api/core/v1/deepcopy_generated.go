...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QGSConfiguration) DeepCopyInto(out *QGSConfiguration) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QGSConfiguration.
func (in *QGSConfiguration) DeepCopy() *QGSConfiguration {
	if in == nil {
		return nil
	}
	out := new(QGSConfiguration)
