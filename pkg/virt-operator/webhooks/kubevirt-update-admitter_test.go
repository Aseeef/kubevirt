...
var _ = Describe("Validating KubeVirtUpdate Admitter", func() {
	...
	DescribeTable("ValidateMigrationPolicyOptions - maxDowntimeMs feature gate", func(
		...
		causes := migrationutils.ValidateMigrationPolicyOptions(sourceField, oldOptions, newOptions, devConfig)
		if expectError {
